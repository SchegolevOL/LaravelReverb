                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="w-full">
                        @foreach($messages as $message)
                                            ...
                                            <div class="w-max grid">
                                                ...
                                                @endif
                                                    ...
                                                    @if(str_starts_with($message->file_type, 'image/'))
                                                        ...
                                                        @else
                                                        <div class="flex items-center justify-between bg-indigo-600">
                                                            ...
                                                            <span class="text-white">{{$message->file_original_name}}</span>
                                                        </div>
                            ...
                            @else
                                {{--Sender section--}}
                                <div class="flex gap-2.5 justify-end pb-10">
                                    <div class="">
                                        <div class="grid mb-2">
                                            <h5 class="text-right text-gray-900 text-sm font-semibold leading-snug pb-1">you {{$message->sender->name}}</h5>
                                            @if($message->message)
                                                <div
                                                    class="px-3.5 py-2 bg-gray-100 rounded justify-start  items-center gap-3 inline-flex">
                                                    <h5 class="text-gray-900 text-sm font-normal leading-snug">{{$message->message}}</h5>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2 w-full  ">
                                    ...
                                    <input id="message-input" wire:keydown="userTyping" wire:model="message"
                                           class="grow shrink basis-0 text-black text-xs font-medium leading-4 focus:outline-none rounded-2xl"
                                ...
                                @if($file)
                                    @php
                                        $is_image = str_starts_with($file->getMimeType(), 'image/') ? true : false;
                                    @endphp
                                    @if($is_image)
                                        <img src="{{$file->temporaryUrl()}}" class="w-12 h-12 object-cover rounded-l-lg border border-gray-300 shadow-md"/>
                                    @else
                                        <span class="w-full max-w-32">{{$file->getClientOriginalName()}}</span>
                                    @endif
                                    <button wire:click="$set('file', null)" type="button" class="text-red-500 ms-2 text-xl">X</button>
                                @endif
                            </div>
                        </form>
                    </div>

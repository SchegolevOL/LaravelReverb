                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex gap-2.5 justify-end pb-10">
                            <div class="">
                                <div class="grid mb-2">
                                    <h5 class="text-right text-gray-900 text-sm font-semibold leading-snug pb-1">{{$message->receiver->name}}</h5>
                        ...
                        <div class="w-full pl-3 pr-1 py-1 rounded-3xl border border-gray-200 items-center gap-2 inline-flex justify-between ">
                            <div class="flex items-center gap-2 w-full  ">
                                ...
                                <input id="message-input" wire:keydown="userTyping" wire:model="message" class="grow shrink basis-0 text-black text-xs font-medium leading-4 focus:outline-none rounded-2xl" placeholder="Type here...">
                            </div>

                ...
                <div class="overflow-x-auto w-full  border rounded-lg border-gray-300">
                    <table class="w-full rounded-xl">
                        ...
                        <tr class="bg-gray-50">
                            ...
                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Post </th>
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <div class="py-1.5 px-2.5 bg-emerald-50 rounded-full flex justify-center w-20 items-center gap-1">
                                        ...
                                        @if($user->is_admin)
                                            ...
                                            <span class="font-medium text-xs text-emerald-600 ">Admin</span>
                                        @else
                                            <svg width="5" height="6" viewBox="0 0 5 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="2.5" cy="3" r="2.5" fill="#DC2626"></circle>
                                            </svg>
                                            <span class="font-medium text-xs text-red-600 ">User</span>
                                        @endif

                                    </div>
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 text-start">
                                    <div class="py-1.5 px-2.5 bg-emerald-50 rounded-full flex justify-center w-20 items-center gap-1">
                                        ...
                                        @if($user->status)
                                            ...
                                            <span class="font-medium ml-2 text-xs text-emerald-600 ">Active</span>
                                        @else
                                            <svg width="5" height="6" viewBox="0 0 5 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="2.5" cy="3" r="2.5" fill="#DC2626"></circle>
                                            </svg>
